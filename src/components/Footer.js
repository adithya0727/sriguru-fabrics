...
<div style={{position: 'fixed', bottom: '24px', right: '16px', zIndex: 50}}>
  
    href="https://wa.me/919663733683?text=Hello! I'm interested in your sarees."
    target="_blank"
    rel="noopener noreferrer"
    className="bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-110"
