...
<div className="fixed bottom-6 right-2 z-50">
    ...
    className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 block w-12 h-12"
    title="Chat with us on WhatsApp"
    style={{minWidth: '48px', minHeight: '48px'}}
  >
    <svg className="w-6 h-6 mx-auto my-auto" fill="currentColor" viewBox="0 0 24 24" style={{marginTop: '6px'}}>
